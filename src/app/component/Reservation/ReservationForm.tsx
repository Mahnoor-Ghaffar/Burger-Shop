...
const ReservationForm = () => {
    return (
        <main className='bg-green-700 p-6 rounded-lg'>
            <GrRestaurant className='w-[5rem] h-[5rem] text-white mt-[2rem] mx-auto' />
            <p className='text-center font-bold uppercase text-[30px] md:text-[40px] lg:text-[50px] mt-[0.5rem] text-white'>
                Reservation
            </p>
            ...
            <div className='mt-[2rem]'>
                ...
                <div className='mt-[2rem] w-[80%] text-center mx-auto'>
                    <button className='px-8 py-3 rounded-lg mb-[3rem] text-[16px] w-full bg-blue-950 transition-all
