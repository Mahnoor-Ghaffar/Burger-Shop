...
const Newsletter = () => {
    return (
        <main id='Newsletter' className='pt-[5rem] pb-[5rem]'>
            <div className='text-center'>
                ...
                <p className='text-black text-opacity-70 w-[85%] md:w-[60%] mx-auto'>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates quos dicta 
                    voluptatum porro molestias soluta debitis, unde dolorem, at autem consectetur distinctio.
                    Corporis vero ea blanditiis debitis consequatur? Amet, deserunt!
                </p>
